...
//    return event_base_loop(global_base, 0);
    #include "sigverify.h"
    const unsigned char *pubkey = (const unsigned char *)"MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAsglEk+HADXZ8LrvK2eeNKQIrRs/drYD9"
                                                         "AQ/Aw1SVoCVqh3wqW8Lkv6GIqG36v+B2cCunrfIg1YYrxBPK38nL9UBY/uMQpea4/kGaHN4T0qxu"
                                                         "ksfLtUJFagpX7/1s44zbN3zjCkLsvSqIqmRS4tvO3JTUozuN4xKM9YtNjhBHfRNWrb4Tun/7cJJ6"
                                                         "na/Hd91QYScvwHlhYG4ZcJmR7rE1DjNZTvWawiOzy1QHSzNBjREpkY0QJ9Yas4AD2bu1AX+IUhbK"
                                                         "+bm8K2EeYuZDEzRRh4gWgrh7KZTHmKC72K16O489wdWuF2hL8s8Vas9977qD4ZxPlUUDMXyWgr4z"
                                                         "XvoboQIDAQAB";
